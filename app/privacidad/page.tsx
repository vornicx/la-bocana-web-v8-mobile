  ...
  return (
    <PublicPage eyebrow="Información legal" title="Privacidad, con claridad." intro="Cómo utilizamos los datos necesarios para gestionar una reserva y atenderte antes, durante y después de tu visita." image="/images/photo-6.jpg">
      <article className="legal-copy">
        {legalDataPending && <aside className="legal-review"><strong>Validación obligatoria antes de producción</strong><span>La razón social y el NIF deben ser confirmados por el titular. No se han completado con estimaciones ni con datos de directorios no oficiales.</span></aside>}
